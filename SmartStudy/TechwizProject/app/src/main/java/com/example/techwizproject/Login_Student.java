...
public class Login_Student extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_Login.setOnClickListener(view -> {
            mAuth.signInWithEmailAndPassword(Email.getText().toString(),Password.getText().toString()).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
                ...
                public void onSuccess(AuthResult authResult) {
                    Toast.makeText(Login_Student.this,"Logged In",Toast.LENGTH_SHORT).show();
                    Intent intent = new Intent(Login_Student.this,IntentActivity.class);
        ...
        btn_Register_Your_Self.setOnClickListener(view -> {
            Intent intent = new Intent(Login_Student.this , RegisterActivity.class);
            startActivity(intent);
        });
